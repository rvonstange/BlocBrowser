...
- (void)loadView {
    ...
    self.textField.placeholder = NSLocalizedString(@"Website URL", @"Placeholder for the URL search");
    ...
    [self.stopButton setTitle:NSLocalizedString(@"Stop", @"Stop Loading command") forState:UIControlStateNormal];
